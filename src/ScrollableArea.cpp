...
namespace rGUI //ScrollableArea
{
    ...
    ScrollableArea::~ScrollableArea()
    {
        ...
        /*for(int a = 0;a <= widgets.size()-1;a++)
        {
            delete widgets[a];
        }
        widgets.clear();*/
    ...
    void ScrollableArea::Print()
    {
        ...
        al_draw_bitmap(wd_bmp, wd_theme.added_thickness/2, wd_theme.added_thickness/2, 0);*/
        wd_PrintEnd();
    }
